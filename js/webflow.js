 ...
 */ !(function (t) {
	...
	function (t, e, n) {
			...
			window.tram = (function (t) {
					...
					if (C.transition) {
							var L = C.timing.dom;
							if (((w.style[L] = l["ease-in-back"][0]), !w.style[L])) for (var P in d) l[P][0] = d[P];
					}
					...
					var z = t.style,
							...
							q = {};
					C.transform && ((Q.transform = [V]), (q = { x: [I, "translateX"], y: [I, "translateY"], rotate: [T], rotateX: [T], rotateY: [T], scale: [g], scaleX: [g], scaleY: [g], skew: [T], skewX: [T], skewY: [T] })),
	...
	function (t, e, n) {
			...
			function at(t) {
					...
					i && n.dispatch((0, g.rawDataImported)(i)),
							u.active ||
									(n.dispatch((0, g.sessionInitialized)({ hasBoundaryNodes: Boolean(document.querySelector(A)), reducedMotion: document.body.hasAttribute("data-wf-ix-vacation") && window.matchMedia("(prefers-reduced-motion)").matches })),
									o &&
											((function (t) {
																												...
																												dt(d, function (e, o, c) {
																														...
																														if (B(p, r.mediaQueryKey)) {
																																var v = function () {
																																		...
																																		Y(i, f) || n.dispatch((0, g.eventStateChanged)(c, i));
																																};
					...
					if (f && f.useFirstGroupAsInitialState) {
							...
							l.forEach(function (t) {
									...
									s.forEach(function (i) {
											...
											gt({ destination: L({ element: i, actionItem: t, elementApi: y }, o), immediate: !0, store: e, element: i, eventId: r, actionItem: t, actionListId: n, pluginInstance: o });
									});
							});
					}
			}
			function ht(t) {
					...
					(0, v.default)(n, function (t) {
							if (!t.continuous) {
									var n = t.actionListId,
											r = t.verbose;
									yt(t, e), r && e.dispatch((0, g.actionListPlaybackChanged)({ actionListId: n, isPlaying: !1 }));
							}
					});
			}
			function Et(t) {
					...
					(0, v.default)(u, function (t) {
							...
							if (t.actionListId === o && t.eventId === n && a) {
									...
									yt(t, e), t.verbose && e.dispatch((0, g.actionListPlaybackChanged)({ actionListId: o, isPlaying: !1 }));
							}
					});
			}
			function _t(t) {
			...
			function gt(t) {
					...
					var R = X(c, A, i, s, y, l);
					r.dispatch((0, g.instanceAdded)((0, a.default)({ instanceId: _, elementId: b, origin: R, refType: S, skipMotion: w, skipToValue: n }, o))),
					...
					if (B(A, O.mediaQueryKey) && (r || n || i)) {
							...
							if (i) {
									if (h) {
											...
											_ && !P && e.dispatch((0, g.actionListPlaybackChanged)({ actionListId: v, isPlaying: !1 }));
									}
									yt(t, e);
							}
					}
	...
	function (t, e, n) {
			n(130), n(132), n(133), n(134), n(69), n(136), n(331), n(332), n(333), (t.exports = n(334));
	},
	function (t, e, n) {
			"use strict";
			var r = n(6);
	...
	function (t, e, n) {
			...
			Object.defineProperty(e, "__esModule", { value: !0 }),
							...
							switch (r.actionTypeId) {
									...
									case at:
											var a,
													...
													s = i(t, D);
											return (
													(a = r.config.widthUnit === W ? (It.test(c) ? parseFloat(c) : parseFloat(n.width)) : (0, f.default)(parseFloat(c), parseFloat(n.width))),
													(u = r.config.heightUnit === W ? (It.test(s) ? parseFloat(s) : parseFloat(n.height)) : (0, f.default)(parseFloat(s), parseFloat(n.height))),
							...
							switch (n.actionTypeId) {
									...
									case at:
											var c = r.getStyle,
													...
													h = v.widthValue,
													E = v.heightValue;
											if (!g.IS_BROWSER_ENV) return { widthValue: h, heightValue: E };
											if (d === W) {
													var y = c(e, P);
									...
									case st:
											var I = n.config,
													...
													b = I.bValue,
													A = I.aValue;
											return { rValue: T, gValue: O, bValue: b, aValue: A };
									case it:
									...
									case K:
											return (function (t, e, n, r, i) {
													...
													Dt(t, g.TRANSFORM_PREFIXED, i),
															...
															(l = c.yValue),
															(d = c.zValue),
															((s === J && void 0 !== d) || (s === tt && void 0 !== d) || (s === et && (void 0 !== f || void 0 !== l))) && a(t, g.TRANSFORM_STYLE_PREFIXED, R);
													var u, c, s, f, l, d;
											})(t, e, n, i, a);
									case q:
													...
													switch (r.actionTypeId) {
															case at:
																	var u = r.config,
																			...
																			p = n.widthValue,
																			v = n.heightValue;
																	void 0 !== p && (s === W && (s = "px"), Dt(t, P, o), a(t, P, p + s)), void 0 !== v && (d === W && (d = "px"), Dt(t, D, o), a(t, D, v + d));
																	break;
															case it:
																	!(function (t, e, n, r) {
																			var i = (0, l.default)(
															...
															case st:
																	var h = pt[r.actionTypeId],
																			...
																			y = n.aValue;
																	Dt(t, h, o), a(t, h, y >= 1 ? "rgb(".concat(E, ",").concat(_, ",").concat(g, ")") : "rgba(".concat(E, ",").concat(_, ",").concat(g, ",").concat(y, ")"));
																	break;
															default:
																	var m = r.config.unit,
																			I = void 0 === m ? "" : m;
											...
											return (function (t, e, n) {
													...
													switch (e.actionTypeId) {
															case ft:
																	...
																	return void (i === N && g.IS_BROWSER_ENV ? r(t, U, g.FLEX_PREFIXED) : r(t, U, i));
													}
											})(t, i, a);
									case $:
					...
					(e.cleanupHTMLElement = function (t, e, n) {
							...
							i(t, B) && Gt({ effect: Mt, actionTypeId: o, elementApi: n })(t);
					}),
					(e.getMaxDurationItemIndex = kt),
			...
			var f = s(n(269)),
					...
					vt = Object.freeze(((i = {}), (0, c.default)(i, g.TRANSFORM_PREFIXED, I), (0, c.default)(i, M, m), (0, c.default)(i, x, x), (0, c.default)(i, C, C), (0, c.default)(i, P, P), (0, c.default)(i, D, D), (0, c.default)(i, L, L), i)),
					ht = {},
					Et = 1;
			var _t = 1;
			var gt = function (t, e) {
			...
			function mt(t) {
					...
					var N,
							...
							D = o && l(yt(o.target));
					if ((P ? ((N = L.limitAffectedElements), (x = D), (C = l(L))) : (x = C = l({ id: T, selector: b, selectorGuids: A })), o && w)) {
							var M = a && (C || !0 === w) ? [a] : d(D);
							if (C) {
									if (w === V)
			...
			var wt =
							...
							o),
					Rt = Object.freeze({ blur: 0, "hue-rotate": 0, invert: 0, grayscale: 0, saturate: 100, sepia: 0, contrast: 100, brightness: 100 }),
			...
			function Ft(t) {
					...
					e.actionItems.forEach(function (t) {
							var e,
									i = t.actionTypeId,
									o = t.config;
							(e = (0, _.isPluginType)(i) ? (0, _.clearPlugin)(i) : Gt({ effect: Xt, actionTypeId: i, elementApi: r })), mt({ config: o, event: n, elementApi: r }).forEach(e);
					});
			}
			var Gt = function (t) {
					var e = t.effect,
			...
			var r = n(3),
					...
					T = function (t, e) {
							...
							if (g && !m)
									...
									for (var G = (A - I) / T, X = g.config.easing, k = h(X, G, f), V = 0, U = a.length; V < U; V++) {
											var B = a[V],
													W = y(s, B, g.config),
					...
					_t =
							...
							(0, o.default)(r, X, {
									...
									handler: function (t) {
											...
											return D !== o.scrollPercent && n.dispatch((0, _.parameterChanged)(w, D)), { scrollPercent: D };
									},
							}),
							(0, o.default)(r, j, Et),
							(0, o.default)(r, F, Et),
...
Webflow.require("ix2").init({
	events: {
			"e-3": {
					...
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|14ac175a-5207-3ab2-b0ae-1451c2179979", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|14ac175a-5207-3ab2-b0ae-1451c2179979", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1676864420979,
			},
			"e-4": {
					id: "e-4",
					name: "",
			...
			"e-9": {
					...
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { selector: ".head", originalId: "63e9d9ed1b2d9e7d28d35b1e|484c38b5-5e81-e51a-bc0c-cc834b0c8fc9", appliesTo: "CLASS" },
					targets: [{ selector: ".head", originalId: "63e9d9ed1b2d9e7d28d35b1e|484c38b5-5e81-e51a-bc0c-cc834b0c8fc9", appliesTo: "CLASS" }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 10, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677040653853,
			},
			"e-11": {
					id: "e-11",
					name: "",
					...
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|936d5128-f43f-8acb-085c-7cc6b828b45d", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|936d5128-f43f-8acb-085c-7cc6b828b45d", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: true, playInReverse: false, scrollOffsetValue: 10, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677041220482,
			},
			"e-13": {
					id: "e-13",
					name: "",
					animationType: "custom",
					eventTypeId: "SCROLL_INTO_VIEW",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-14" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|40da5665-feff-56a7-1688-af8608005f8a", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|40da5665-feff-56a7-1688-af8608005f8a", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 10, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677041420363,
			},
			"e-15": {
					id: "e-15",
					name: "",
					animationType: "custom",
					eventTypeId: "SCROLL_INTO_VIEW",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-16" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|00807ecd-8dda-972b-3e81-9c782654ecf2", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|00807ecd-8dda-972b-3e81-9c782654ecf2", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677042048377,
			},
			"e-17": {
					id: "e-17",
					name: "",
					animationType: "custom",
					eventTypeId: "SCROLL_INTO_VIEW",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-8", affectedElements: {}, playInReverse: false, autoStopEventId: "e-18" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|469be334-8297-ed70-b2b4-b35dcb219c2d", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|469be334-8297-ed70-b2b4-b35dcb219c2d", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677042059440,
			},
			"e-19": {
					id: "e-19",
					name: "",
					animationType: "custom",
					eventTypeId: "SCROLL_INTO_VIEW",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-7", affectedElements: {}, playInReverse: false, autoStopEventId: "e-20" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|f745919e-fb27-68ef-d491-db8103c0ac27", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|f745919e-fb27-68ef-d491-db8103c0ac27", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 10, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677042118429,
			},
			"e-21": {
					id: "e-21",
					name: "",
					animationType: "custom",
					eventTypeId: "SCROLL_INTO_VIEW",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-10", affectedElements: {}, playInReverse: false, autoStopEventId: "e-22" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|7dce5c0e-3e9b-0f95-5ee4-bbf92059e14b", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|7dce5c0e-3e9b-0f95-5ee4-bbf92059e14b", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677042185976,
			},
			"e-23": {
					id: "e-23",
					name: "",
					...
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|906aa7c0-b69a-842d-5f16-667c54033aa7", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|906aa7c0-b69a-842d-5f16-667c54033aa7", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677042372919,
			},
			"e-25": {
					id: "e-25",
					name: "",
					...
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|65f393dd-61b9-ffba-0ce5-e713fe70cea2", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|65f393dd-61b9-ffba-0ce5-e713fe70cea2", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: 0, scrollOffsetUnit: "%", delay: null, direction: null, effectIn: null },
					createdOn: 1677043164789,
			},
			"e-27": {
					id: "e-27",
					name: "",
					...
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-13", affectedElements: {}, playInReverse: false, autoStopEventId: "e-28" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|556be0a2-c955-cada-eb6f-a7f3bff3fd4a", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|556be0a2-c955-cada-eb6f-a7f3bff3fd4a", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677045372545,
			},
			"e-28": {
					id: "e-28",
					name: "",
					...
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-14", affectedElements: {}, playInReverse: false, autoStopEventId: "e-27" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|556be0a2-c955-cada-eb6f-a7f3bff3fd4a", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|556be0a2-c955-cada-eb6f-a7f3bff3fd4a", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677045372546,
			},
			"e-29": {
					id: "e-29",
					name: "",
					...
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|9d737d72-a2c7-31ac-8046-a32e14b84ba7", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|9d737d72-a2c7-31ac-8046-a32e14b84ba7", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677045766093,
			},
			"e-30": {
					id: "e-30",
					name: "",
					animationType: "custom",
					eventTypeId: "MOUSE_OUT",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-14", affectedElements: {}, playInReverse: false, autoStopEventId: "e-29" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|9d737d72-a2c7-31ac-8046-a32e14b84ba7", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|9d737d72-a2c7-31ac-8046-a32e14b84ba7", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677045766094,
			},
			"e-31": {
					id: "e-31",
					name: "",
					...
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|6028e2a5-4766-2036-7d1e-b380e2b2fdb1", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|6028e2a5-4766-2036-7d1e-b380e2b2fdb1", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677049917014,
			},
			"e-32": {
					id: "e-32",
					name: "",
					animationType: "custom",
					eventTypeId: "MOUSE_OUT",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-16", affectedElements: {}, playInReverse: false, autoStopEventId: "e-31" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|6028e2a5-4766-2036-7d1e-b380e2b2fdb1", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|6028e2a5-4766-2036-7d1e-b380e2b2fdb1", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677049917015,
			},
			"e-33": {
					id: "e-33",
					name: "",
					...
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { selector: ".icon-container.for-footer.github", originalId: "63e9d9ed1b2d9e7d28d35b1e|0dc75358-8a94-3230-9004-94878c418111", appliesTo: "CLASS" },
					targets: [{ selector: ".icon-container.for-footer.github", originalId: "63e9d9ed1b2d9e7d28d35b1e|0dc75358-8a94-3230-9004-94878c418111", appliesTo: "CLASS" }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677050121159,
			},
			"e-34": {
					id: "e-34",
					name: "",
			...
			"e-35": {
					...
					animationType: "custom",
					eventTypeId: "MOUSE_OVER",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-15", affectedElements: {}, playInReverse: false, autoStopEventId: "e-36" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|5ab88794-0b15-37c8-290a-92912dd628a0", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|5ab88794-0b15-37c8-290a-92912dd628a0", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677050143522,
			},
			"e-36": {
					id: "e-36",
					name: "",
					animationType: "custom",
					eventTypeId: "MOUSE_OUT",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-16", affectedElements: {}, playInReverse: false, autoStopEventId: "e-35" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|5ab88794-0b15-37c8-290a-92912dd628a0", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|5ab88794-0b15-37c8-290a-92912dd628a0", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677050143523,
			},
			"e-37": {
					id: "e-37",
					name: "",
					animationType: "custom",
					eventTypeId: "MOUSE_OVER",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-15", affectedElements: {}, playInReverse: false, autoStopEventId: "e-38" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|2a1950f3-4f17-8488-6375-cb1a2f4dfa4a", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|2a1950f3-4f17-8488-6375-cb1a2f4dfa4a", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677050156031,
			},
			"e-38": {
					id: "e-38",
					name: "",
					animationType: "custom",
					eventTypeId: "MOUSE_OUT",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-16", affectedElements: {}, playInReverse: false, autoStopEventId: "e-37" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|2a1950f3-4f17-8488-6375-cb1a2f4dfa4a", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|2a1950f3-4f17-8488-6375-cb1a2f4dfa4a", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677050156032,
			},
			"e-39": {
					id: "e-39",
					name: "",
					animationType: "custom",
					eventTypeId: "MOUSE_OVER",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-15", affectedElements: {}, playInReverse: false, autoStopEventId: "e-40" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|b475eaa9-e0a4-40c2-bbbc-946e34b9f4d3", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|b475eaa9-e0a4-40c2-bbbc-946e34b9f4d3", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677050173301,
			},
			"e-40": {
					id: "e-40",
					name: "",
					animationType: "custom",
					eventTypeId: "MOUSE_OUT",
					action: { id: "", actionTypeId: "GENERAL_START_ACTION", config: { delay: 0, easing: "", duration: 0, actionListId: "a-16", affectedElements: {}, playInReverse: false, autoStopEventId: "e-39" } },
					mediaQueries: ["main", "medium", "small", "tiny"],
					target: { id: "63e9d9ed1b2d9e7d28d35b1e|b475eaa9-e0a4-40c2-bbbc-946e34b9f4d3", appliesTo: "ELEMENT", styleBlockIds: [] },
					targets: [{ id: "63e9d9ed1b2d9e7d28d35b1e|b475eaa9-e0a4-40c2-bbbc-946e34b9f4d3", appliesTo: "ELEMENT", styleBlockIds: [] }],
					config: { loop: false, playInReverse: false, scrollOffsetValue: null, scrollOffsetUnit: null, delay: null, direction: null, effectIn: null },
					createdOn: 1677050173346,
			},
	},
	actionLists: {
			a: {
					id: "a",
					title: "FAQ-custom-open",
					actionItemGroups: [
							{
									actionItems: [
											{
													...
													config: {
															...
															easing: "",
															duration: 500,
															target: { useEventTarget: "SIBLINGS", selector: ".faq-answer", selectorGuids: ["01e03165-6e84-d9e8-c22a-1e99204e6a15"] },
															heightValue: 0,
															widthUnit: "PX",
															heightUnit: "vw",
															locked: false,
											...
											},
											{
													...
													config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "SIBLINGS", selector: ".faq-answer", selectorGuids: ["01e03165-6e84-d9e8-c22a-1e99204e6a15"] }, value: 0, unit: "" },
											},
											{
													id: "a-n-2",
													actionTypeId: "GENERAL_DISPLAY",
													config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "SIBLINGS", selector: ".faq-answer", selectorGuids: ["01e03165-6e84-d9e8-c22a-1e99204e6a15"] }, value: "none" },
											},
									],
							},
							{
									actionItems: [
											{
													id: "a-n-4",
													actionTypeId: "GENERAL_DISPLAY",
													config: { delay: 0, easing: "", duration: 0, target: { useEventTarget: "SIBLINGS", selector: ".faq-answer", selectorGuids: ["01e03165-6e84-d9e8-c22a-1e99204e6a15"] }, value: "block" },
											},
									],
							},
							{
									actionItems: [
											...
											},
											{
													...
													config: {
															...
															easing: "ease",
															duration: 100,
															target: { useEventTarget: "CHILDREN", selector: ".faq-chevron", selectorGuids: ["9424f706-430d-8859-c8c5-a84534a11370"] },
															zValue: 180,
															xUnit: "DEG",
															yUnit: "DEG",
															zUnit: "deg",
											...
											},
											{
													id: "a-n-6",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "ease", duration: 100, target: { useEventTarget: "SIBLINGS", selector: ".faq-answer", selectorGuids: ["01e03165-6e84-d9e8-c22a-1e99204e6a15"] }, value: 1, unit: "" },
											},
									],
							},
					],
					useFirstGroupAsInitialState: true,
					createdOn: 1676864448224,
			},
			"a-2": {
					id: "a-2",
					title: "FAQ-custom-close",
					actionItemGroups: [
							{
									actionItems: [
											{
											...
											},
											{
													id: "a-2-n-7",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "ease", duration: 100, target: { useEventTarget: "SIBLINGS", selector: ".faq-answer", selectorGuids: ["01e03165-6e84-d9e8-c22a-1e99204e6a15"] }, value: 0, unit: "" },
											},
									],
							},
							{
									...
									actionItems: [
											{
													...
													config: {
															...
															easing: "",
															duration: 500,
															target: { useEventTarget: "CHILDREN", selector: ".head", selectorGuids: ["676f055b-921d-1376-1d24-17525ad2d753"] },
															yValue: 5,
															xUnit: "PX",
															yUnit: "vw",
															zUnit: "PX",
											...
											},
											{
													id: "a-6-n-2",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".head", selectorGuids: ["676f055b-921d-1376-1d24-17525ad2d753"] }, value: 0, unit: "" },
											},
									],
							},
							{
									actionItems: [
											...
											},
											{
													id: "a-6-n-4",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "inOutQuint", duration: 600, target: { useEventTarget: "CHILDREN", selector: ".head", selectorGuids: ["676f055b-921d-1376-1d24-17525ad2d753"] }, value: 1, unit: "" },
											},
									],
							},
					],
					useFirstGroupAsInitialState: true,
					createdOn: 1677040683987,
			},
			"a-7": {
					id: "a-7",
					title: "move up on scroll-describtion",
					actionItemGroups: [
							{
									actionItems: [
											{
													...
													config: {
															...
															easing: "",
															duration: 500,
															target: { useEventTarget: "CHILDREN", selector: ".card-describtion", selectorGuids: ["51849c91-1dc3-d695-f982-cdb3f6f3dc4a"] },
															yValue: 5,
															xUnit: "PX",
															yUnit: "vw",
															zUnit: "PX",
											...
											},
											{
													id: "a-7-n-2",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".card-describtion", selectorGuids: ["51849c91-1dc3-d695-f982-cdb3f6f3dc4a"] }, value: 0, unit: "" },
											},
									],
							},
							{
									actionItems: [
											...
											},
											{
													id: "a-7-n-4",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "inOutQuint", duration: 600, target: { useEventTarget: "CHILDREN", selector: ".card-describtion", selectorGuids: ["51849c91-1dc3-d695-f982-cdb3f6f3dc4a"] }, value: 1, unit: "" },
											},
									],
							},
					],
									...
									actionItems: [
											{
													...
													config: {
															...
															easing: "",
															duration: 500,
															target: { useEventTarget: "CHILDREN", selector: ".card-opportunities", selectorGuids: ["f8d84741-96d0-2dc6-5162-c0504e226d4f"] },
															yValue: 5,
															xUnit: "PX",
															yUnit: "vw",
															zUnit: "PX",
											...
											},
											{
													id: "a-8-n-2",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".card-opportunities", selectorGuids: ["f8d84741-96d0-2dc6-5162-c0504e226d4f"] }, value: 0, unit: "" },
											},
									],
							},
							{
									actionItems: [
											...
											},
											{
													id: "a-8-n-4",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "inOutQuint", duration: 600, target: { useEventTarget: "CHILDREN", selector: ".card-opportunities", selectorGuids: ["f8d84741-96d0-2dc6-5162-c0504e226d4f"] }, value: 1, unit: "" },
											},
									],
							},
					],
									...
									actionItems: [
											{
													...
													config: {
															...
															easing: "",
															duration: 500,
															target: { useEventTarget: "CHILDREN", selector: ".collection-list-wrapper", selectorGuids: ["68cd8628-2d10-85e5-27fe-2899d2585416"] },
															yValue: 5,
															xUnit: "PX",
															yUnit: "vw",
															zUnit: "PX",
											...
											},
											{
													id: "a-10-n-2",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".collection-list-wrapper", selectorGuids: ["68cd8628-2d10-85e5-27fe-2899d2585416"] }, value: 0, unit: "" },
											},
									],
							},
							{
			...
			"a-11": {
					id: "a-11",
					title: "move up on scroll-discord",
					actionItemGroups: [
							{
									actionItems: [
											{
													...
													config: {
															...
															easing: "",
															duration: 500,
															target: { useEventTarget: "CHILDREN", selector: ".banner", selectorGuids: ["1e781911-4074-fcb3-5795-d5a0962e08f9"] },
															yValue: 5,
															xUnit: "PX",
															yUnit: "vw",
															zUnit: "PX",
											...
											},
											{
													id: "a-11-n-2",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".banner", selectorGuids: ["1e781911-4074-fcb3-5795-d5a0962e08f9"] }, value: 0, unit: "" },
											},
									],
							},
							{
									actionItems: [
											...
											},
											{
													id: "a-11-n-4",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "inOutQuint", duration: 600, target: { useEventTarget: "CHILDREN", selector: ".banner", selectorGuids: ["1e781911-4074-fcb3-5795-d5a0962e08f9"] }, value: 1, unit: "" },
											},
									],
							},
					],
									...
									actionItems: [
											{
													...
													config: {
															...
															easing: "",
															duration: 500,
															target: { useEventTarget: "CHILDREN", selector: ".offer-structure", selectorGuids: ["bf88ed1b-a8f6-e40e-a5e8-ff32526729a0"] },
															yValue: 5,
															xUnit: "PX",
															yUnit: "vw",
															zUnit: "PX",
											...
											},
											{
													id: "a-12-n-2",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "", duration: 500, target: { useEventTarget: "CHILDREN", selector: ".offer-structure", selectorGuids: ["bf88ed1b-a8f6-e40e-a5e8-ff32526729a0"] }, value: 0, unit: "" },
											},
									],
							},
							{
									actionItems: [
											...
											},
											{
													id: "a-12-n-4",
													actionTypeId: "STYLE_OPACITY",
													config: { delay: 0, easing: "inOutQuint", duration: 600, target: { useEventTarget: "CHILDREN", selector: ".offer-structure", selectorGuids: ["bf88ed1b-a8f6-e40e-a5e8-ff32526729a0"] }, value: 1, unit: "" },
											},
									],
							},
					],
									...
									actionItems: [
											{
													...
													config: {
															...
															easing: "inQuint",
															duration: 200,
															target: { useEventTarget: "CHILDREN", selector: ".arrow", selectorGuids: ["2bfcc341-32c1-caf7-8057-15ad668ad948"] },
															xValue: 0,
															xUnit: "vw",
															yUnit: "PX",
															zUnit: "PX",
			...
			"a-15": {
									...
									actionItems: [
											{
													...
													config: {
															...
															easing: "ease",
															duration: 200,
															target: { useEventTarget: "CHILDREN", selector: ".icon-container.for-footer", selectorGuids: ["b3ac64df-fa45-5b7b-8306-4b611a75a021", "37f57475-ba67-b32f-0eb7-3fa65c513677"] },
															xValue: 1.5,
															yValue: 1.5,
															locked: true,
													},
					...
					useFirstGroupAsInitialState: false,
					createdOn: 1677049921413,
			},
			"a-16": {
					id: "a-16",
					title: "icons-hover out",
					actionItemGroups: [
							{
									actionItems: [
											{
